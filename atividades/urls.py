...
urlpatterns = [
    ...
    path('Edificios/create', views.createEdificio, name='addEdificio'),
    ...
    path('UnidadeOrganicas/create', views.createUnidadeOrganica, name='addUnidadeOrganica'),
    ...
    path('Departamentos/create', views.createDepartamento, name='addDepartamento'),
